...
NSString *const  kCellIdentifier_LXShareItemCell = @"LXShareItemCell";

@interface LXShareItemCell()
...
@implementation LXShareItemCell
...
- (void)setShareItem:(LXShareItem *)shareItem{
