...
#define SCREEN_WIDTH_SHARE ([UIScreen mainScreen].bounds.size.width)
#define SCREEN_HEIGHT_SHARE ([UIScreen mainScreen].bounds.size.height)
#define LXShareItemCellSize CGSizeMake(80, 100)
