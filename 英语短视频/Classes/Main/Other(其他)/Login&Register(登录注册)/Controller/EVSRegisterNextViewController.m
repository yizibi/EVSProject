...
- (IBAction)vertifyButtonClick:(EVSGetIdentifyCodeButton *)sender {
    LXLog(@"验证码请求");
    [sender getIdentifyCodeWithPhoneNumber:@"17602152185" type:@"register_user" areaCode:nil success:^(NSDictionary *result) {
        LXLog(@"%@",result);
