...
- (void)getIdentifyCodeWithPhoneNumber:(NSString *)phoneNumber type:(NSString *)type areaCode:(NSString *)areaCode success:(void (^)(NSDictionary *))success fail:(void (^)(NSError *))fail{
    ...
    [EVServerManger getVerificationCodeByMobile:phoneNumber type:type areaCode:areaCode success:^(NSDictionary *result) {
        if (success) {
            success(result);
        }
    } fail:^(NSError *error) {
